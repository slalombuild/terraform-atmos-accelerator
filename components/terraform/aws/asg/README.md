...
| <a name="input_userdata_file"></a> [userdata\_file](#input\_userdata\_file) | The userdata script name from component/asg/userdata to use for the instances | `string` | `"cubes_user_data.sh"` | no |
