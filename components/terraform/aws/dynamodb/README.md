...
# Component: terraform-aws-dynamodb

# Description: |-
  This module creates a danymodb table. It supports many configurations like global secondary indexes and non_key_attributes.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_dynamodb"></a> [dynamodb](#module\_dynamodb) | cloudposse/dynamodb/aws | v0.34.0 |
