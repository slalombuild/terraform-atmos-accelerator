...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_api_gateway"></a> [api\_gateway](#module\_api\_gateway) | cloudposse/api-gateway/aws | 0.3.1 |
...
| Name | Type |
|------|------|
| [aws_lambda_permission.allow_apigateway_invoke_lambda](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lambda_permission) | resource |
| [aws_caller_identity.current](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/caller_identity) | data source |
| [aws_iam_policy_document.rest_api_policy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
...
| <a name="input_api_gateway_account_settings_enabled"></a> [api\_gateway\_account\_settings\_enabled](#input\_api\_gateway\_account\_settings\_enabled) | Enable/disable CloudWatch Api gateway account settings. This is required to log any api gateway requests | `bool` | `false` | no |
...
| <a name="input_lambda_function_names"></a> [lambda\_function\_names](#input\_lambda\_function\_names) | Add ApiGateway permission to call lambda:InvokeFunction | `set(string)` | `[]` | no |
...
| <a name="input_open_api_file_name"></a> [open\_api\_file\_name](#input\_open\_api\_file\_name) | OpenApidoc name for API Gateway integration | `string` | `""` | no |
| <a name="input_openapi_config"></a> [openapi\_config](#input\_openapi\_config) | The OpenAPI specification for the API | `any` | `null` | no |
...
| <a name="input_region"></a> [region](#input\_region) | AWS Region for the Provider to make the deployments | `string` | n/a | yes |
| <a name="input_rest_api_policy"></a> [rest\_api\_policy](#input\_rest\_api\_policy) | The IAM policy document for the API. | `any` | `null` | no |
...
| <a name="input_vpc_cidr"></a> [vpc\_cidr](#input\_vpc\_cidr) | CIRD of the vpc | `string` | `""` | no |
