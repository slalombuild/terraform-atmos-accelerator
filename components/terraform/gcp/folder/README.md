...
| [google_folder_iam_binding.iam_bindings](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/folder_iam_binding) | resource |
...
| <a name="input_iam_bindings"></a> [iam\_bindings](#input\_iam\_bindings) | One or more objects containing IAM members (users, groups, service accounts, etc.) and their respective roles that will be assigned to the folder. | <pre>list(object({<br>    members = list(string),<br>    role    = string<br>  }))</pre> | `[]` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_create_time"></a> [create\_time](#output\_create\_time) | Timestamp of when the Folder was created. It is assigned by the server and in RFC3339 UTC "Zulu" format, accurate to nanoseconds. Example: "2014-10-02T15:01:23.045123456Z". |
| <a name="output_lifecycle_state"></a> [lifecycle\_state](#output\_lifecycle\_state) | The lifecycle state of the folder such as ACTIVE or DELETE\_REQUESTED. |
| <a name="output_name"></a> [name](#output\_name) | The resource name of the Folder: folders/{folder\_id}. |
<!-- END-TERRAFORM-DOCS -->