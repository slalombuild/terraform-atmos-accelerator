...
variable "lock" {
  ...
  default     = null
  description = "The lock level to apply to the Key Vault. Default is `null`. Possible values are `null`, `CanNotDelete`, and `ReadOnly`."
...
- `virtual_network_subnets`(optional) When you use data source to get subnet id, Defaults to `[]`.
DESCRIPTION
...
variable "role_assignments" {
  ...
  - `principal_name` - The Name of the principal to assign the role to.
