...
module "diagnostic_setting_naming" {
  count   = local.create_cosmosdb_account && var.diagnostic_setting.enabled && (var.diagnostic_setting.log_analytics_workspace_name != null || var.diagnostic_setting.storage_account_name != null) ? 1 : 0
  version = "0.4.2"
  source  = "Azure/naming/azurerm"
...
module "cosmosdb_naming" {
  ...
  version = "0.4.2"
  source  = "Azure/naming/azurerm"
  prefix  = [module.this.namespace, module.this.environment, var.cosmosdb_account_name]
}
